...
//    public static Board newInstance(User user, String boardThumbnailImageUrl, String title, String content, Boolean isPublic) {
//        return new Board(user, boardThumbnailImageUrl, title, content, isPublic);
//    }
